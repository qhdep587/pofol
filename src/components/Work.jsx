    ...
    <div>
      ...
      <div className="work">
        <ul className="edu-text-box">
          ...
          <span style={{ fontSize: '19px', color: 'ivory' }}>핵심역량</span>
          <li style={{ fontSize: '10px' }}>&nbsp;</li>
          <li className="list-item" style={{ fontSize: '16px' }}>
            &nbsp;&nbsp;- 많은 트래픽, 데이터 무게에 관한 이슈 경험
          </li>
          <li className="list-item" style={{ fontSize: '16px' }}>
            &nbsp;&nbsp;- kafka연동 / 계좌인증, 사업자인증 등의 외부 api 연동 경험
          </li>
          <li className="list-item" style={{ fontSize: '16px' }}>
        ...
        <ul className="edu-text-box">
          <span className="edu-title">◆</span>&nbsp;&nbsp;
          <span style={{ fontSize: '19px', color: 'ivory' }}>경력</span>
          <li style={{ fontSize: '10px' }}>&nbsp;</li>
          ...
          <li className="list-item list-item-sub" style={{ position: 'relative', Left: '4.2%' }}>
            <span style={{ fontSize: '15px', display: 'inline-block' }}>
              &nbsp;&nbsp;&nbsp;퍼블, 프론트작업 / chart라이브러리 이용하여 대시보드 작업
            </span>
          </li>
          ...
          <li className="list-item list-item-sub" style={{ position: 'relative', Left: '4.2%' }}>
            <span style={{ fontSize: '15px', display: 'inline-block' }}>
              &nbsp;&nbsp;&nbsp;2020.10 ~ 2023.07
              <span style={{ color: '#1e7c60', fontWeight: 600 }}> ( </span>
              재직중<span style={{ color: '#1e7c60', fontWeight: 600 }}> )</span>
            </span>
            &nbsp;&nbsp;&nbsp;
          </li>
          <li className="list-item list-item-sub" style={{ position: 'relative', Left: '4.2%' }}>
          ...
          <li className="list-item list-item-sub" style={{ position: 'relative', Left: '4.2%' }}>
            <span style={{ fontSize: '15px', display: 'inline-block' }}>
              &nbsp;&nbsp;&nbsp;- <span style={{ color: '#1e7c60', fontWeight: 600 }}> ( </span>
              마켓컬리<span style={{ color: '#1e7c60', fontWeight: 600 }}> )</span> 3p 파트너센터 /
              파트너어드민
            </span>
          </li>
          <li className="list-item list-item-sub" style={{ position: 'relative', Left: '4.2%' }}>
